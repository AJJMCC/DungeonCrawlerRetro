...
create a bit map file in your favourite image editor you can select both height and width as needed. Paint the whole image in black, black will be the void color on your map. to add walls use pure Red Color. 
Walless floor will be white, for outside corners use pure Green Color, to add Collumns you'll need pure Blue and diagonal walls use Magenta.
